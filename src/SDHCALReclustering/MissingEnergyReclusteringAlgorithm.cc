...
namespace sdhcal_content
{
  ...
  pandora::StatusCode MissingEnergyReclusteringAlgorithm::Run()
  {
    ...
    for(unsigned int i=0 ; i<clusterVector.size() ; ++i)
    {
      ...
      PANDORA_RETURN_RESULT_IF(pandora::STATUS_CODE_SUCCESS, !=, SDHCALContentApi::InitializeReclustering(*this,
          ...
          endClusteringAlgIter != clusteringAlgIter ; ++clusteringAlgIter)
      {
        ...
        PANDORA_RETURN_RESULT_IF(pandora::STATUS_CODE_SUCCESS, !=, SDHCALContentApi::RunReclusteringAlgorithm(*this,
        ...
        PANDORA_RETURN_RESULT_IF(pandora::STATUS_CODE_SUCCESS, !=, SDHCALContentApi::PostRunReclusteringAlgorithm(*this, reclusterClusterListName));
      ...
      PANDORA_RETURN_RESULT_IF(pandora::STATUS_CODE_SUCCESS, !=, SDHCALContentApi::EndReclustering(*this, bestReclusterClusterListName));
    }
