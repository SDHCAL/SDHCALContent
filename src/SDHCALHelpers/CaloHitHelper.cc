...
namespace sdhcal_content
{
      ...
      pandora::CaloHitList &seedCaloHitList, bool discriminateLeafHits)
  {
        ...
        endIter != iter ; ++iter)
    {
      ...
      if(SDHCALContentApi::IsSeed(pCaloHit) && !(SDHCALContentApi::IsLeaf(pCaloHit) && discriminateLeafHits))
      ...
      pandora::CaloHitList &leafCaloHitList, bool discriminateSeedHits)
  {
        ...
        endIter != iter ; ++iter)
    {
      ...
      if(SDHCALContentApi::IsLeaf(pCaloHit) && !(discriminateSeedHits && !SDHCALContentApi::IsSeed(pCaloHit)))
  ...
  {
    const ConnectorList &connectorList(SDHCALContentApi::GetConnectorList(pCaloHit, direction));
      ...
      pandora::CartesianVector &direction, unsigned int depth)
  {
    ...
    const ConnectorList &connectorList(SDHCALContentApi::GetConnectorList(pCaloHit, connectorDirection));
