...
namespace sdhcal_content
{
  ...
  pandora::StatusCode ReclusterHelper::SplitTreeFromCluster(const pandora::Algorithm &algorithm, const sdhcal_content::CaloHit *const pSeedCaloHit,
      const pandora::Cluster *const pOriginalCluster, const pandora::Cluster *&pSeparatedTreeCluster, const std::string &originalClusterListName)
  {
    ...
    if(!SDHCALContentApi::IsSeed(pSeedCaloHit))
      return pandora::STATUS_CODE_INVALID_PARAMETER;
