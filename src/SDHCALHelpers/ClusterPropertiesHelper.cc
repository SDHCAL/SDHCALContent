...
pandora::StatusCode sdhcal_content::ClusterPropertiesHelper::CalcClusterProperties(const pandora::Cluster* pCluster, 
...
pandora::StatusCode sdhcal_content::ClusterPropertiesHelper::GetClusterProperties(const pandora::Cluster* pCluster, 
		 float& minHitLayer, float& clusterVol, float& energyRatio, 
...
TVector3 sdhcal_content::ClusterPropertiesHelper::GetMainAxis(const pandora::Cluster* const pCluster)
{
	TVector3 axis;
...
pandora::StatusCode sdhcal_content::ClusterPropertiesHelper::GetAxisInformation(
