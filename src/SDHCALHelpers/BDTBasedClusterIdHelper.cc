...
Reader* sdhcal_content::BDTBasedClusterIdHelper::m_reader = NULL;

float sdhcal_content::BDTBasedClusterIdHelper::m_minHitLayer          = 0.;
float sdhcal_content::BDTBasedClusterIdHelper::m_clusterVol           = 0.;
float sdhcal_content::BDTBasedClusterIdHelper::m_energyRatio          = 0.;
float sdhcal_content::BDTBasedClusterIdHelper::m_hitOutsideRatio      = 0.;
float sdhcal_content::BDTBasedClusterIdHelper::m_axisLengthRatio      = 0.;
float sdhcal_content::BDTBasedClusterIdHelper::m_shortAxisLengthRatio = 0.;

bool  sdhcal_content::BDTBasedClusterIdHelper::m_isMethodBooked       = false;


sdhcal_content::BDTBasedClusterIdHelper::~BDTBasedClusterIdHelper() 
{
...
pandora::StatusCode sdhcal_content::BDTBasedClusterIdHelper::BDTEvaluate(const pandora::Cluster* cluster, float& bdtEvaluation)
{ 
