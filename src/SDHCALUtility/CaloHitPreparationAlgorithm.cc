...
namespace sdhcal_content
{
  ...
  pandora::StatusCode CaloHitPreparationAlgorithm::Run()
  {
        ...
        endIter != iter ; ++iter)
    {
      ...
      {
        const sdhcal_content::CaloHit *const pCaloHit(dynamic_cast<const sdhcal_content::CaloHit *>(*hitIter));
        ...
        SDHCALContentApi::CaloHitMetadata caloHitMetadata;
        ...
        if(pCaloHit->GetHitType() == pandora::MUON)
        {
          ...
          PANDORA_RETURN_RESULT_IF(pandora::STATUS_CODE_SUCCESS, !=, SDHCALContentApi::AlterMetadata(*this, pCaloHit, caloHitMetadata));
