/**
 *  @file   SDHCALShowerProfilePlugin.cc
 * 
...
SDHCALShowerProfilePlugin::SDHCALShowerProfilePlugin() :
...
void SDHCALShowerProfilePlugin::CalculateShowerStartLayer(const Cluster *const pCluster, unsigned int &showerStartLayer) const
{
#if 0
...
void SDHCALShowerProfilePlugin::CalculateLongitudinalProfile(const Cluster *const pCluster, float &profileStart, float &profileDiscrepancy) const
{
...
void SDHCALShowerProfilePlugin::CalculateTransverseProfile(const Cluster *const pCluster, const unsigned int maxPseudoLayer, ShowerPeakList &showerPeakList,
    const bool inclusiveMode) const
{
    ...
    std::sort(showerPeakList.begin(), showerPeakList.end(), SDHCALShowerProfilePlugin::SortShowerPeakListByEnergy);
}

//------------------------------------------------------------------------------------------------------------------------------------------

void SDHCALShowerProfilePlugin::CalculateTrackBasedTransverseProfile(const Cluster *const pCluster, const unsigned int maxPseudoLayer, const Track *const pMinTrack,
    const TrackVector &trackVector, ShowerPeakList &showerPeakListPhoton, ShowerPeakList &showerPeakListNonPhoton) const
{
    ...
    std::sort(showerPeakListPhoton.begin(), showerPeakListPhoton.end(), SDHCALShowerProfilePlugin::SortShowerPeakListByEnergy);
    std::sort(showerPeakListNonPhoton.begin(), showerPeakListNonPhoton.end(), SDHCALShowerProfilePlugin::SortShowerPeakListByEnergy);
}

//------------------------------------------------------------------------------------------------------------------------------------------

void SDHCALShowerProfilePlugin::CalculateTracklessTransverseShowers(const Cluster *const pCluster, const unsigned int maxPseudoLayer, TwoDShowerProfile &showerProfile,
...
void SDHCALShowerProfilePlugin::CalculateTrackNearbyTransverseShowers(const Cluster *const pCluster, const unsigned int maxPseudoLayer, const Track *const pMinTrack,
...
void SDHCALShowerProfilePlugin::CreateEmptyTwoDShowerProfile(TwoDShowerProfile &twoDShowerProfile) const
{
...
void SDHCALShowerProfilePlugin::InitialiseTransverseProfile(const pandora::Cluster *const pCluster, const unsigned int maxPseudoLayer, TwoDShowerProfile &showerProfile) const
{
...
void SDHCALShowerProfilePlugin::InitialiseTransverseProfileWithTracks(const pandora::Cluster *const pCluster, const unsigned int maxPseudoLayer, const Track *const pMinTrack,
...
void SDHCALShowerProfilePlugin::CalculateProjectionAxes(const Cluster *const pCluster, CartesianVector &innerLayerCentroid, CartesianVector &uAxis,
...
void SDHCALShowerProfilePlugin::InitialiseTwoDShowerProfile(const Cluster *const pCluster, const unsigned int maxPseudoLayer, const CartesianVector &innerLayerCentroid,
...
void SDHCALShowerProfilePlugin::FindTracksProjection(const Cluster *const pCluster, const TrackVector &trackVector, const CartesianVector &innerLayerCentroid,
...
float SDHCALShowerProfilePlugin::GetCellLengthScale(const Cluster *const pCluster) const
{
...
void SDHCALShowerProfilePlugin::MaskLowHeightRegions(TwoDShowerProfile &showerProfile) const
{
...
void SDHCALShowerProfilePlugin::FindRawPeaksInTwoDShowerProfile(TwoDShowerProfile &showerProfile, ShowerPeakObjectVector &showerPeakObjectVector) const
{
    for (int uBin = 0; uBin < m_transProfileNBins; ++uBin)
    {
        for (int vBin = 0; vBin < m_transProfileNBins; ++vBin)
...
void SDHCALShowerProfilePlugin::AssociateUnavailableBinsToPeaks(const TwoDShowerProfile &showerProfile, ShowerPeakObjectVector &showerPeakObjectVector) const
{
    for (int uBin = 0; uBin < m_transProfileNBins; ++uBin)
    {
        for (int vBin = 0; vBin < m_transProfileNBins; ++vBin)
...
void SDHCALShowerProfilePlugin::AssociateBinsToPeaks(const TwoDShowerProfile &showerProfile, ShowerPeakObjectVector &showerPeakObjectVector) const
{
    for (int uBin = 0; uBin < m_transProfileNBins; ++uBin)
    {
        for (int vBin = 0; vBin < m_transProfileNBins; ++vBin)
...
void SDHCALShowerProfilePlugin::AssociateBinsToPeaks(const TwoDBinVector &twoDBinVector, ShowerPeakObjectVector &showerPeakObjectVector) const
{
...
void SDHCALShowerProfilePlugin::ApplyQualityCutPeakNBin(ShowerPeakObjectVector &showerPeakObjectVector, TwoDBinVector &twoDBinVector) const
{
...
bool SDHCALShowerProfilePlugin::PassQualityCutPeakNBin(const ShowerPeakObject &showerPeakObject) const
{
...
void SDHCALShowerProfilePlugin::MarkPeaksCloseToTracks(const TwoDBinVector &trackProjectionVector, ShowerPeakObjectVector &showerPeakObjectVector) const
{
    for (ShowerPeakObjectVector::iterator iter = showerPeakObjectVector.begin(), iterEnd = showerPeakObjectVector.end(); iter !=iterEnd; ++iter)
    {
        ShowerPeakObject &showerPeakObject(*iter);
...
void SDHCALShowerProfilePlugin::MatchPeaksInTwoSlices(const ShowerPeakObjectVector &showerPeakObjectVectorFirst, ShowerPeakObjectVector &showerPeakObjectVectorNext) const
{
...
void SDHCALShowerProfilePlugin::ProcessShowerProfile(TwoDShowerProfile &showerProfile, ShowerPeakObjectVector &showerPeakObjectVector) const
{
...
void SDHCALShowerProfilePlugin::FindHitPositionProjection(const CartesianVector &hitPosition, const CartesianVector &innerLayerCentroid, const CartesianVector &uAxis,
...
void SDHCALShowerProfilePlugin::FindBoundaryBins(const int uBin, const int vBin, const int uEdgeLow, const int uEdgeHigh, const int vEdgeLow, const int vEdgeHigh,
...
void SDHCALShowerProfilePlugin::ConvertBinsToShowerLists(const TwoDShowerProfile &showerProfile, const ShowerPeakObjectVector &showerPeakObjectVector,
...
bool SDHCALShowerProfilePlugin::IsPeak(TwoDShowerProfile &showerProfile, const int uBin, const int vBin ) const
{
...
bool SDHCALShowerProfilePlugin::Check8NeighbourFull(TwoDShowerProfile &showerProfile, const int uBin, const int vBin) const
{
...
bool SDHCALShowerProfilePlugin::Check8NeighbourFast(TwoDShowerProfile &showerProfile, const int uBin, const int vBin) const
{
    for (int uBinStart = uBin - 1, uBinEnd = uBin + 1; uBinStart <= uBinEnd; ++uBinStart)
    {
        for (int vBinStart = vBin - 1, vBinEnd = vBin + 1; vBinStart <= vBinEnd; ++vBinStart)
...
float SDHCALShowerProfilePlugin::CalculatePeakFindingMetric(const float distance, const float energy) const
{
    ...
    switch (m_transProfilePeakFindingMetric)
    {
        ...
        default:
            std::cout << "SDHCALShowerProfilePlugin::CalculatePeakFindingMetric invalid parameter for m_transProfilePeakFindingMetric: " << m_transProfilePeakFindingMetric << std::endl;
            throw StatusCodeException(STATUS_CODE_INVALID_PARAMETER);
    }
}
...
void SDHCALShowerProfilePlugin::CalculateBestPeakUsingMetric(ShowerPeakObjectVector &showerPeakObjectVector, const int uBin, const int vBin,
...
bool SDHCALShowerProfilePlugin::HasPhotonCandidate(const ShowerPeakObjectVector &showerPeakObjectVector) const
{
    for (ShowerPeakObjectVector::const_iterator iter = showerPeakObjectVector.begin(), iterEnd = showerPeakObjectVector.end(); iter !=iterEnd; ++iter)
    {
        const ShowerPeakObject  &showerPeakObject(*iter);
...
bool SDHCALShowerProfilePlugin::SortShowerPeakListByEnergy(const ShowerPeak &lhs, const ShowerPeak &rhs)
{
...
StatusCode SDHCALShowerProfilePlugin::ReadSettings(const TiXmlHandle xmlHandle)
{
