/// \file SDHCALPseudoLayerPlugin.cc
/*
 *
 * SDHCALPseudoLayerPlugin.cc source template automatically generated by a class generator
...
namespace sdhcal_content
{
  ...
  SDHCALPseudoLayerPlugin::SDHCALPseudoLayerPlugin() :
      m_barrelInnerR(0.f),
      m_endCapInnerZ(0.f),
  ...
  pandora::StatusCode SDHCALPseudoLayerPlugin::Initialize()
  {
    try
    {
    ...
    {
      std::cout << "SDHCALPseudoLayerPlugin: Incomplete geometry - consider using a different PseudoLayerCalculator." << std::endl;
  ...
  unsigned int SDHCALPseudoLayerPlugin::GetPseudoLayer(const pandora::CartesianVector &positionVector) const
  {
  ...
  pandora::StatusCode SDHCALPseudoLayerPlugin::GetPseudoLayer(const float rCoordinate, const float zCoordinate, const float rCorrection,
  ...
  pandora::StatusCode SDHCALPseudoLayerPlugin::FindMatchingLayer(const float position, const LayerPositionList &layerPositionList,
  ...
  void SDHCALPseudoLayerPlugin::StoreLayerPositions()
  {
    ...
    {
      std::cout << "SDHCALPseudoLayerPlugin: No layer positions specified." << std::endl;
    ...
    {
      std::cout << "SDHCALPseudoLayerPlugin: Duplicate layer position detected." << std::endl;
  ...
  void SDHCALPseudoLayerPlugin::StoreLayerPositions(const pandora::SubDetector &subDetector, LayerPositionList &layerPositionList)
  {
    if (!subDetector.IsMirroredInZ())
    {
      std::cout << "SDHCALPseudoLayerPlugin: Error, detector must be symmetrical about z=0 plane." << std::endl;
  ...
  void SDHCALPseudoLayerPlugin::StoreDetectorOuterEdge()
  {
    const pandora::GeometryManager *const pGeometryManager(this->GetPandora().GetGeometry());
    ...
    {
      std::cout << "SDHCALPseudoLayerPlugin: Layers specified outside detector edge." << std::endl;
      throw pandora::StatusCodeException(pandora::STATUS_CODE_FAILURE);
    }
  ...
  void SDHCALPseudoLayerPlugin::StorePolygonAngles()
  {
    const pandora::GeometryManager *const pGeometryManager(this->GetPandora().GetGeometry());
  ...
  void SDHCALPseudoLayerPlugin::StoreOverlapCorrectionDetails()
  {
    const pandora::GeometryManager *const pGeometryManager(this->GetPandora().GetGeometry());
  ...
  float SDHCALPseudoLayerPlugin::GetMaximumRadius(const AngleVector &angleVector, const float x, const float y) const
  {
  ...
  void SDHCALPseudoLayerPlugin::FillAngleVector(const unsigned int symmetryOrder, const float phi0, AngleVector &angleVector) const
  {
  ...
  pandora::StatusCode SDHCALPseudoLayerPlugin::ReadSettings(const pandora::TiXmlHandle xmlHandle)
  {
    m_useCoordinateCorrections = false;
