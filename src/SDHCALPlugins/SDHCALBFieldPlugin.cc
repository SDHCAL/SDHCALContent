/// \file SDHCALBFieldPlugin.cc
/*
 *
 * SDHCALBFieldPlugin.cc source template automatically generated by a class generator
...
namespace sdhcal_content
{
  ...
  SDHCALBFieldPlugin::SDHCALBFieldPlugin(const float innerBField, const float muonBarrelBField, const float muonEndCapBField) :
  ...
  float SDHCALBFieldPlugin::GetBField(const pandora::CartesianVector &positionVector) const
  {
  ...
  pandora::StatusCode SDHCALBFieldPlugin::Initialize()
  {
    try
    {
    ...
    {
      std::cout << "SDHCALBFieldPlugin: Unable to extract Muon EndCap and Coil geometry." << std::endl;
  ...
  pandora::StatusCode SDHCALBFieldPlugin::ReadSettings(const pandora::TiXmlHandle /*xmlHandle*/)
  {
    return pandora::STATUS_CODE_SUCCESS;
  }
