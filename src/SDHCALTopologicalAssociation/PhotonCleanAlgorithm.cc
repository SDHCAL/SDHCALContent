...
namespace sdhcal_content
{
  ...
  pandora::StatusCode PhotonCleanAlgorithm::Run()
  {
	...
	SDHCALParticleIdPlugins::SDHCALPhotonId::SetRecord(m_recordPhotonIDInfo);
	  ...
	  try
	  {
		 ...
		 if(isPhoton)
		 {
	         ...
	         for(auto hitIter = clusterCaloHitList.begin(); hitIter != clusterCaloHitList.end(); ++hitIter)
	         {
				...
				{
					SDHCALContentApi::RemoveFromCluster(*this, pCluster, pCaloHit);
				}
	         }
		 }
	  }
	...
	SDHCALParticleIdPlugins::SDHCALPhotonId::SetRecord(false);
