...
namespace sdhcal_content
{
      ...
      pandora::ClusterVector &photonFragmentVector) const
  {
    ...
    SDHCAL_LOG( "NearbyTrackPhotonRemovalAlg: Will remove " << photonFragmentVector.size() << " photons" << std::endl);
    SDHCAL_LOG( "NearbyTrackPhotonRemovalAlg: Removed " << totalRemovedNHits << " hits from photon clusters" << std::endl);
