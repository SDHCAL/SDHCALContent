  ...
  pandora::StatusCode ClusterFragmentMergingAlgorithm::Run()
  {
        ...
        iEndIter != iIter ; ++iIter)
    {
          ...
          jEndIter != jIter ; ++jIter)
      {
        ...
        {
          const sdhcal_content::CaloHit *pLeafCaloHit = dynamic_cast<const sdhcal_content::CaloHit *>(*leafIter);
      ...
      {
        // merge clusters
        PANDORA_RETURN_RESULT_IF(pandora::STATUS_CODE_SUCCESS, !=, SDHCALContentApi::MergeAndDeleteClusters(*this, pParentCluster, pDaughterCluster));
