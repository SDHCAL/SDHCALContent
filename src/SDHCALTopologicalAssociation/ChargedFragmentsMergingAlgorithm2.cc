...
namespace sdhcal_content
{
  ...
  bool ChargedFragmentsMergingAlgorithm2::CheckNearbyClusterWithCharge(const sdhcal_content::SDHCALCluster* pCluster, std::vector<sdhcal_content::SDHCALCluster*>& nearbyClusters, int charge)
  {
  ...
  void ChargedFragmentsMergingAlgorithm2::SearchProperClusters(SDHCALCluster* startingCluster, 
  ...
  pandora::StatusCode ChargedFragmentsMergingAlgorithm2::GetEligibleClusters(std::vector<SDHCALCluster*>& clusterVector) const
  {
	clusterVector.clear();
