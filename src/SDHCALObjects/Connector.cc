...
namespace sdhcal_content
{
  ...
  Connector::Connector(const sdhcal_content::CaloHit *const pFromCaloHit, const sdhcal_content::CaloHit *const pToCaloHit, float referenceLength,
  ...
  const sdhcal_content::CaloHit *Connector::Get(ConnectorDirection direction) const
  {
