/// \file SDHCALMetaData.cc
/*
 *
 * SDHCALMetaData.cc source template automatically generated by a class generator
...
namespace sdhcal_content
{
  ...
  CaloHitMetaData::CaloHitMetaData(sdhcal_content::CaloHit *const pCaloHit) :
    m_pCaloHit(pCaloHit),
    m_isLeaf(true),
    m_isSeed(true)
  {
  ...
  const sdhcal_content::CaloHit *CaloHitMetaData::GetCaloHit() const
  {
    return m_pCaloHit;
  }
  ...
  bool CaloHitMetaData::IsConnected(const sdhcal_content::CaloHit *const pCaloHit) const
  {
  ...
  bool CaloHitMetaData::IsConnected(const sdhcal_content::CaloHit *const pCaloHit, ConnectorDirection direction) const
  {
  ...
  pandora::StatusCode CaloHitMetaData::FindConnector(const sdhcal_content::CaloHit *const pCaloHit, const Connector *&pConnector) const
  {
    pConnector = NULL;
  ...
  pandora::StatusCode CaloHitMetaData::FindConnector(const sdhcal_content::CaloHit *const pCaloHit, ConnectorDirection direction,
