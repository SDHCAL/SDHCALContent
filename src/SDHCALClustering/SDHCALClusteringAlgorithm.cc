/// \file SDHCALClusteringAlgorithm.cc
/*
 *
 * SDHCALClusteringAlgorithm.cc source template automatically generated by a class generator
...
{
    const pandora::CaloHitList*  SDHCALClusteringAlgorithm::m_pCaloHitList = nullptr; 
    pandora::CaloHitList   SDHCALClusteringAlgorithm::m_ecalCaloHitList; 
	pandora::CaloHitList   SDHCALClusteringAlgorithm::m_hcalCaloHitList; 
	pandora::CaloHitList   SDHCALClusteringAlgorithm::m_muonCaloHitList;

  pandora::StatusCode SDHCALClusteringAlgorithm::Run()
  {
  ...
  pandora::StatusCode SDHCALClusteringAlgorithm::SplitCaloHitList(const pandora::CaloHitList *const pCaloHitList, pandora::CaloHitList &ecalCaloHitList,
  ...
  pandora::StatusCode SDHCALClusteringAlgorithm::ConnectCaloHits(const ConnectorAlgorithmToolVector &toolVector) const
  {
  ...
  pandora::StatusCode SDHCALClusteringAlgorithm::CreateClusters() const
  {
        ...
        endIter != iter ; ++iter)
    {
      ...
      PANDORA_RETURN_RESULT_IF(pandora::STATUS_CODE_SUCCESS, !=, SDHCALContentApi::CreateSDHCALCluster(*this, clusterParameters, pCluster));
	  ...
	  for(auto& caloHit : clusterCaloHitList)
	  {
        const sdhcal_content::CaloHit *const pSDHCALCaloHit = dynamic_cast<const sdhcal_content::CaloHit *const>(caloHit);
		  std::cout << " calo hit mother cluser: " << pSDHCALCaloHit->GetMother() << ", cluster energy: "  
			  << pSDHCALCaloHit->GetMother()->GetHadronicEnergy() << std::endl;
	  }
#endif
    }
    ...
    if(m_useAsIndependent)
    {
        ...
        std::string newClusterName("SDHCALClusteringAlgClusters");
        std::stringstream ss;
        ss << this;
  ...
  pandora::StatusCode SDHCALClusteringAlgorithm::ReadSettings(const pandora::TiXmlHandle xmlHandle)
  {
