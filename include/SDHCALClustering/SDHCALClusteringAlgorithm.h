  /// \file SDHCALClusteringAlgorithm.h
/*
 *
 * SDHCALClusteringAlgorithm.h header template automatically generated by a class generator
...
#ifndef SDHCALCLUSTERINGALGORITHM_H
#define SDHCALCLUSTERINGALGORITHM_H
...
/** 
 * @brief SDHCALClusteringAlgorithm class
 */ 
class SDHCALClusteringAlgorithm : public pandora::Algorithm
{
public:
	/**
...
inline pandora::Algorithm *SDHCALClusteringAlgorithm::Factory::CreateAlgorithm() const
{
    return new SDHCALClusteringAlgorithm();
}

} 

#endif  //  SDHCALCLUSTERINGALGORITHM_H
