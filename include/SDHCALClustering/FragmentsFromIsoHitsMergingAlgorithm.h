/**
 *
 *  @file   SDHCALContent/include/SDHCALClustering/FragmentsFromIsoHitsMergingAlgorithm.h
 * 
 */
...
typedef sdhcal_content::KDTreeLinkerAlgo<const pandora::CaloHit*, 4> HitKDTree;
typedef sdhcal_content::KDTreeNodeInfoT<const pandora::CaloHit*, 4> HitKDNode;
