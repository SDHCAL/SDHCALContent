...
public:
	 ...
	 */
	const sdhcal_content::CaloHit *GetFrom() const;

	/**
	 *  @brief  Get the 'to' calo hit
	 */
	const sdhcal_content::CaloHit *GetTo() const;

	/**
	 *  @brief  Get the 'to' or 'from' calo hit (from (to) for BACKWARD_DIRECTION (FORWARD_DIRECTION))
	 */
	const sdhcal_content::CaloHit *Get(ConnectorDirection direction) const;
	 ...
	 */
	bool IsFrom(const sdhcal_content::CaloHit *const pCaloHit) const;

	/**
	 *  @brief  Whether the calo hit is the 'to' calo hit of this connector
	 */
	bool IsTo(const sdhcal_content::CaloHit *const pCaloHit) const;
...
private:
	 ...
	 */
	Connector(const sdhcal_content::CaloHit *const pFromCaloHit, const sdhcal_content::CaloHit *const pToCaloHit,
