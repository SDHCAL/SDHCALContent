  /// \file SDHCALMetaData.h
/*
 *
 * SDHCALMetaData.h header template automatically generated by a class generator
...
#ifndef SDHCAL_META_DATA_H
#define SDHCAL_META_DATA_H 1
...
public:
	 ...
	 */
	CaloHitMetaData(sdhcal_content::CaloHit *const pCaloHit);
	 ...
	 */
	const sdhcal_content::CaloHit *GetCaloHit() const;
	 ...
	 */
	bool IsConnected(const sdhcal_content::CaloHit *const pCaloHit) const;
	 ...
	 */
	bool IsConnected(const sdhcal_content::CaloHit *const pCaloHit, ConnectorDirection direction)  const;
	 ...
	 */
	pandora::StatusCode FindConnector(const sdhcal_content::CaloHit *const pCaloHit, const Connector *&pConnector) const;
	 ...
	 *
	 */
	pandora::StatusCode FindConnector(const sdhcal_content::CaloHit *const pCaloHit, ConnectorDirection direction,
...
private:
	...
	sdhcal_content::CaloHit                   *m_pCaloHit;                 ///< The handled sdhcal calo hit
