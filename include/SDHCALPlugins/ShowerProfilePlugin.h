/**
 *  @file   SDHCALShowerProfilePlugin.h
 * 
 *  @brief  Header file for the shower profile plugin class.
 * 
 *  $Log: $
 */
#ifndef SDHCAL_SHOWER_PROFILE_PLUGIN_H
#define SDHCAL_SHOWER_PROFILE_PLUGIN_H 1
...
{
/**
 *  @brief  SDHCALShowerProfilePlugin class
 */
class SDHCALShowerProfilePlugin : public pandora::ShowerProfilePlugin
{
public:
    /**
     *  @brief  Default constructor
     */
    SDHCALShowerProfilePlugin();
...
inline void SDHCALShowerProfilePlugin::CalculateTransverseProfile(const pandora::Cluster *const pCluster, const unsigned int maxPseudoLayer, ShowerPeakList &showerPeakList) const
{
...
inline SDHCALShowerProfilePlugin::ShowerProfileEntry::ShowerProfileEntry() :
    m_isAvailable(true),
    m_energy(0.f),
...
inline SDHCALShowerProfilePlugin::ShowerPeakObject::ShowerPeakObject(const float energy, const int uBin, const int vBin) :
    m_isAvailable(true),
...
inline float SDHCALShowerProfilePlugin::ShowerPeakObject::GetPeakEnergy() const
{
    return m_energy;
}
...
inline int SDHCALShowerProfilePlugin::ShowerPeakObject::GetPeakUBin() const
{
    return m_uBin;
}
...
inline int SDHCALShowerProfilePlugin::ShowerPeakObject::GetPeakVBin() const
{
    return m_vBin;
}
