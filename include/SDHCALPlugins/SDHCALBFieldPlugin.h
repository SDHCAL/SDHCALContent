  /// \file SDHCALBFieldPlugin.h
/*
 *
 * SDHCALBFieldPlugin.h header template automatically generated by a class generator
...
#ifndef SDHCALBFIELDPLUGIN_H
#define SDHCALBFIELDPLUGIN_H
...
/**
 *  @brief  SDHCALBFieldPlugin class
 */
class SDHCALBFieldPlugin : public pandora::BFieldPlugin
{
public:
    /**
     ...
     */
	SDHCALBFieldPlugin(const float innerBField, const float muonBarrelBField, const float muonEndCapBField);
