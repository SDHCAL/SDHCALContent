...
{
	typedef std::map<const sdhcal_content::CaloHit*, pandora::CaloHitList> CaloHitCleaningMap;
...
private:
	 ...
	 */
	//float GetOrderParameter(const sdhcal_content::Connector *const pConnector, const pandora::CartesianVector &referenceDirection) const;
	 ...
	 */
	pandora::CartesianVector GetReferenceVector(const sdhcal_content::CaloHit *const pCaloHit) const;
