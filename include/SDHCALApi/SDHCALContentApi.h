  /// \file SDHCALContentApi.h
/*
 *
 * SDHCALContentApi.h header template automatically generated by a class generator
...
#ifndef SDHCALCONTENTAPI_H
#define SDHCALCONTENTAPI_H
...
namespace sdhcal_content { class CaloHit; class Connector; }

// logging macro
#define SDHCAL_LOG( message ) if( PandoraContentApi::GetSettings(*this)->ShouldDisplayAlgorithmInfo() ) std::cout << message


/** 
 *  @brief  SDHCALContentApi class
 */ 
class SDHCALContentApi 
{
public:
	/**
	 ...
	 */
	static pandora::StatusCode AlterMetadata(const pandora::Algorithm &algorithm, const sdhcal_content::CaloHit *const pCaloHit, const CaloHitMetadata &caloHitMetadata);
...
public:
	 ...
	 *  @return  boolean
	 */
	static bool IsConnected(const sdhcal_content::CaloHit *const pCaloHit1, const sdhcal_content::CaloHit *const pCaloHit2);
	 ...
	 *  @return boolean
	 */
	static bool IsConnected(const sdhcal_content::CaloHit *const pCaloHit1, const sdhcal_content::CaloHit *const pCaloHit2, sdhcal_content::ConnectorDirection direction);
	 ...
	 */
	static pandora::StatusCode FindConnector(const sdhcal_content::CaloHit *const pCaloHit1, const sdhcal_content::CaloHit *const pCaloHit2, const sdhcal_content::Connector *&pConnector);
	 ...
	 *  @param  pConnector the connector address to receive
	 */
	static pandora::StatusCode FindConnector(const sdhcal_content::CaloHit *const pCaloHit1, const sdhcal_content::CaloHit *const pCaloHit2, sdhcal_content::ConnectorDirection direction,
	 ...
	 *  @return  boolean
	 */
	static bool HasAnyConnection(const sdhcal_content::CaloHit *const pCaloHit);
	 ...
	 */
	static const sdhcal_content::ConnectorList &GetConnectorList(const sdhcal_content::CaloHit *const pCaloHit);
	 ...
	 *  @return  ConnectorList the connector list (std::set<const Connector*>)
	 */
	static const sdhcal_content::ConnectorList &GetConnectorList(const sdhcal_content::CaloHit *const pCaloHit, sdhcal_content::ConnectorDirection direction);
	 ...
	 *  @return  boolean
	 */
	static bool IsSeed(const sdhcal_content::CaloHit *const pCaloHit);
	 ...
	 *  @return  boolean
	 */
	static bool IsLeaf(const sdhcal_content::CaloHit *const pCaloHit);
	 ...
	 */
	static pandora::StatusCode Connect(const sdhcal_content::CaloHit *const pCaloHit1, const sdhcal_content::CaloHit *const pCaloHit2,
			sdhcal_content::ConnectorDirection direction, float referenceLength = 1.f, unsigned int creationStage = -1);
	 ...
	 */
	static pandora::StatusCode Connect(const sdhcal_content::CaloHit *const pCaloHit1, const sdhcal_content::CaloHit *const pCaloHit2,
			sdhcal_content::ConnectorDirection direction, const sdhcal_content::Connector *&pConnector, float referenceLength = 1.f,
	 ...
	 */
	static pandora::StatusCode RemoveConnectionBetween(const sdhcal_content::CaloHit *const pCaloHit1, const sdhcal_content::CaloHit *const pCaloHit2);
	 ...
	 */
	static pandora::StatusCode RemoveAndDeleteConnector(const sdhcal_content::Connector *const pConnector);
	 ...
	 */
	static pandora::StatusCode RemoveAndDeleteAllConnections(const sdhcal_content::CaloHit *const pCaloHit);
	 ...
	 */
	static pandora::StatusCode Tag(const sdhcal_content::CaloHit *const pCaloHit, sdhcal_content::HitTag tag, bool value);
	 ...
	 *  @return  boolean
	 */
	static bool IsTagged(const sdhcal_content::CaloHit *const pCaloHit, sdhcal_content::HitTag tag);
	 ...
	 */
	static pandora::StatusCode ResetTags(const sdhcal_content::CaloHit *const pCaloHit);

	/**
	 *  @brief  Initialize SDHCAL re-clustering. Save calo hit meta data and create a new one for each calo hit
	 *
	...
	static pandora::StatusCode CreateSDHCALCluster(const pandora::Algorithm &algorithm, 
		PandoraContentApi::Cluster::Parameters clusterParameters, const pandora::Cluster *&pCluster);
	...
	static pandora::StatusCode RemoveConnector(const sdhcal_content::Connector *const pConnector);
...
private:
	 ...
	 */
	static sdhcal_content::ClusterFactory m_clusterFactory;
}; 


#endif  //  SDHCALCONTENTAPI_H
