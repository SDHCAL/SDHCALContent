  /// \file SDHCALInputTypes.h
/*
 *
 * SDHCALInputTypes.h header template automatically generated by a class generator
...
#ifndef SDHCALINPUTTYPES_H
#define SDHCALINPUTTYPES_H
...
template <>
inline bool pandora::PandoraInputType<sdhcal_content::SemiDigitalThresholdList>::IsValid(const sdhcal_content::SemiDigitalThresholdList &list) const
{
	if(list.empty())
		return false;
...
template <>
inline bool pandora::PandoraInputType<sdhcal_content::SemiDigitalThreshold>::IsValid(const sdhcal_content::SemiDigitalThreshold &t) const
{
