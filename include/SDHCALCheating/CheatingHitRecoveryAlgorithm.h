/**
 *  @file   SDHCALContent/include/SDHCALCheating/CheatingHitRecoveryAlgorithm.h
 * 
 *  @brief  Header file for the cheating cluster cleaning algorithm class.
 * 
 *  $Log: $
 */
#ifndef SDHCAL_CHEATING_HIT_RECOVERY_ALGORITHM_H
#define SDHCAL_CHEATING_HIT_RECOVERY_ALGORITHM_H 1
